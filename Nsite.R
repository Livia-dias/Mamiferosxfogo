...
model = glm(Nsite ~ pa_type + NDVImean_5 + Dist_water + Prob_fogo, data = treino, family = quasipoisson, na.action = "na.fail")
...
residuos_prob=(as.numeric(teste$Nsite)-1)-predicted
source("metricas.R")
